    ...
    return (
        <div className='AnimalTradingCards'>
            ...
            <div className="flex space-x-2 mt-2">
                <Code code={CODE1} url='https://wallpapercave.com/wp/wp11725637.png'/>
                <Code code={CODE2} url={'https://constructs.stampede-design.com/wp-content/uploads/2014/10/css3.jpg'}/>
            </div>
        </div>
    );
};
